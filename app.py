...
from AxiomX.helpers import pyro_utils
from AxiomX.helpers.render_template import render_page
...
<body>
    <div class="container">
        <div class="hero">
            <img src="https://files.catbox.moe/kjdsse.jpg" alt="AxiomX Vibe">
        ...
        <footer>
            <p>Made with ❤️ by <a href="https://t.me/creativeaxiom" target="_blank">@XoMnv</a></p>
        </footer>
    </div>
</body>
</html>    
