...
from AxiomX import BOT_ID, BOT_USERNAME
from AxiomX.helpers.utils import search_text
from AxiomX.db.chatbot import CHAT_IDS
...
class ReplyToBot(MessageFilter):
    def filter(self, message):
        ...
        or search_text("(@|#)AxiomX", message.text)))
