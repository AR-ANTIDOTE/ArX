...
from AxiomX import app, DEV_LIST, SUDO_USERS, BOT_ID, BOT_USERNAME, PREFIX, PREMIUM_USERS, font
import pyrogram
from telegram.helpers import mention_html
from AxiomX.db.disable import get_disabled
from pyrogram import Client, enums
from pyrogram.types import Message
from AxiomX.db.sudo import get_all_sudo_users
from AxiomX.helpers.utils import extract_user
from AxiomX.helpers.mod_helper import check_mod_permission_fast
...
def loggable(func):
    ...
    async def log_action(update: Update, context: ContextTypes.DEFAULT_TYPE, *args, **kwargs):
        ...
        if result and chat:
            from AxiomX.helpers.log_helper import log_action as send_log
    ...
    async def wrapper(client,*args,**kwargs):
        try:
            ...
            if uid not in _premium_set:
                try:await m.reply_text("⚠️ This command only works for 'AxiomX Premium' users!")
                except:pass
                return
