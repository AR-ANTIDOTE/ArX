...
from AxiomX import app, BOT_ID, BOT_USERNAME, SUDO_USERS, OWNER_ID, font
from AxiomX.helpers.decorator import Command, admin_check, only_groups, Callbacks
from AxiomX.helpers.log_helper import log_action
from AxiomX.helpers.utils import extract_user
from AxiomX.db.federation_db import (
...
async def setfedlang_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    from AxiomX.db.federation_db import set_fed_lang
