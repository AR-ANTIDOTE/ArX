...
from AxiomX.helpers.utils import extract_user, async_cache
from AxiomX.helpers.decorator import Command, admin_check, only_groups, disableable, protect_sudos, Callbacks, Messages, mod_permission, get_effective_chat_id
from AxiomX import BOT_ID, app, pbot, font
from pyrogram import enums
from pyrogram.enums import ChatMembersFilter, ParseMode, ChatMemberStatus
from AxiomX.db.mod import *
from AxiomX.helpers.log_helper import log_action
from pyrogram import Client, filters
from pyrogram.types import Message, CallbackQuery, InlineKeyboardMarkup as IKM, InlineKeyboardButton as IKB
from pyrogram.errors import RPCError
from AxiomX import pbot, prefix_cmds
import io
from AxiomX.db.admincache import get_last_admins, save_admins
from AxiomX.db.connection_db import get_connected_chat
...
async def reload_admin_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        from AxiomX.helpers.cache_manager import smart_cache_refresh
        from AxiomX import pbot
        ...
        if not user_id and context.args:
            ...
            if first_arg.startswith('@'):
                try:
                    ...
                    try:
                        from AxiomX.db.users import get_user_id_by_username
