...
from AxiomX import pbot as app, font
from AxiomX.db.whisper import save_whisper, get_whisper, mark_read
from AxiomX.helpers.scripts import GPTGeneration
        ...
        for track in results[:10]:
            ...
            answers.append(
                InlineQueryResultArticle(
                    ...
                    thumb_url=track['thumbnail'] or "https://files.catbox.moe/d2l5nj.png",
                    input_message_content=InputTextMessageContent(
                        f"🎥 **{track['title']}**\n👤 {track['artist']}\n\n⏳ Preparing..."
                    ),
                    reply_markup=InlineKeyboardMarkup([[
    ...
    if (text.startswith("!dl ") or text.startswith("!reel ")) and len(text.split()) > 1:
        ...
        return await q.answer([
            InlineQueryResultPhoto(
                ...
                photo_url="https://files.catbox.moe/kjdsse.jpg",
