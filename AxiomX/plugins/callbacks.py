...
from AxiomX import SUPPORT_CHAT, UPDATE_CHANNEL, BOT_NAME
from AxiomX.helpers.pyro_utils import gen_link
from AxiomX import font, MODULE, HELP_CMD_IMG, HELP_MODULE_IMG, pbot
from AxiomX.plugins.base import SE
from AxiomX.helpers.misc import help_button, help_keyboard_data, get_help_button
...
async def module_help_callback(client, query):
    ...
    if len(data) == 2:
        ...
        caption = (
            ...
            f"- ɪη ᴧ ɢꝛσυᴘ: ɢєᴛ ʏσυꝛ ɢꝛσυᴘ sєᴛᴛɪηɢs.</b></blockquote>\n"
            f"•─ ⋅ ⋅ ⋅ ─────── ⋅ • ⋅ ─────── ⋅ ⋅ ⋅ ─•"
        )
