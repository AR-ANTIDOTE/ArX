...
async def gpt(query: str) -> str:
    ...
    try:
        ...
        system = f"You are AxiomX, a helpful AI assistant. Respond only in {lang}. Be conversational, friendly and concise."
