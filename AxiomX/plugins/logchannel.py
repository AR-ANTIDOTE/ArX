from AxiomX import font, pbot, prefix_cmds, app
from telegram import Update, constants
from telegram.ext import ContextTypes, filters, CommandHandler
from AxiomX.helpers.decorator import Command, admin_check, only_groups, Messages, get_effective_chat_id, user_admin
from AxiomX.db.logchannel_db import (
...
async def __migrate__(old_chat_id, new_chat_id):
    from AxiomX.db.logchannel_db import set_log_channel, get_log_channel, stop_chat_logging
