...
from AxiomX import pbot as bot, aiohttpsession as session, telegraph, app, telegraph_create, font
from pyrogram import filters, types as pyro_types, Client
from AxiomX.helpers.pyro_utils import get_media_from_message
from AxiomX.helpers.decorator import Command, send_action, Callbacks
from AxiomX.helpers.utils import get_ua, UserId
from AxiomX.helpers.scripts import get_pypi_info, google_search, get_trendings, paste, ddg_search
