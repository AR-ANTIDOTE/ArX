...
from AxiomX import app, pbot, DEV_LIST, BOT_USERNAME, BOT_ID, LOGS_CHANNEL, database, OWNER_ID, SUDO_USERS, font
...
from AxiomX.helpers.decorator import Command, Messages, devs_only, sudos_only, protect_sudos, Callbacks, RestrictedCallback
from AxiomX.helpers.scripts import paste
from AxiomX.helpers.utils import get_as_document, extract_user
from AxiomX.db.users import get_all_users, get_user_id_by_username, add_user, update_users_status_to_inactive, update_users_status_to_active, get_all_active_users
from AxiomX.db.chats import get_all_chats
from AxiomX import db, LOGGER
from AxiomX.db import ignore
from pyrogram import enums, types, StopPropagation
from AxiomX.db import *
from AxiomX.db.sudo import get_all_sudo_users
from AxiomX.db.gban import *
...
async def restart(update, context):
    ...
    os.execl(sys.executable, sys.executable, "-m", "AxiomX")
...
from AxiomX import pbot, database as db 
