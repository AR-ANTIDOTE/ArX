...
from AxiomX import pbot, prefix_cmds, font, LOGS_CHANNEL, BOT_USERNAME
from AxiomX.db.approval_db import is_user_approved
from AxiomX.db.antinsfw_db import get_antinsfw, set_antinsfw, get_antinsfw_admin, set_antinsfw_admin
import config
...
async def is_user_admin(chat_id: int, user_id: int):
    from AxiomX.helpers.decorator import protected_ids, user_admin_cache
