...
from AxiomX import app, prefix_cmds, BOT_ID, font, pbot
from AxiomX.helpers.decorator import protected_ids
from AxiomX.db.nightmode_db import add_nightmode, rm_nightmode, is_nightmode, get_all_nightmode_chats
...
async def nightmode_cmd(_, message: Message):
    ...
    from AxiomX.db.nightmode_db import get_nightmode_data
