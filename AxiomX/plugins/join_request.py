...
from AxiomX.db.join_request import toggle_request, is_request_enabled
        ...
        if "USER_ALREADY_PARTICIPANT" in str(e):
            ...
            if msg_id:
                try:
                    ...
                    pass
            return await cb.answer(font("ℹ️ User already in group. Message deleted."), show_alert=True)
        else:
