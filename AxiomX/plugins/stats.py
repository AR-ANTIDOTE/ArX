...
import pytz
import inspect
from AxiomX import pbot, prefix_cmds, font
from AxiomX.db.sudo import get_all_sudo_users
from AxiomX.db.antinsfw_db import count_antinsfw_enabled
from AxiomX.helpers.pyro_utils import no_channel
...
async def get_stats_text():
    try:
        ...
        tasks = [
            create_task(safe_call("AxiomX.db.users", "count_users", (), 0)),
            create_task(safe_call("AxiomX.db.users", "get_all_active_users", (), [])),
            create_task(safe_call("AxiomX.db.chats", "collection.count_documents", ({},), 0)),
            create_task(safe_call("AxiomX.db.autofilter", "autofilter.distinct", ("chat_id",), [])),
            create_task(safe_call("AxiomX.db.chatbot", "collection.distinct", ("chat_id",), [])),
            create_task(safe_call("AxiomX.db.filter", "filters_collection.distinct", ("chat_id",), [])),
            create_task(safe_call("AxiomX.db.warn_db", "count_warns", (), 0)),
            create_task(safe_call("AxiomX.db.warn_db", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.warn_db", "count_warn_filters", (), 0)),
            create_task(safe_call("AxiomX.db.warn_db", "count_warn_filter_chats", (), 0)),
            create_task(safe_call("AxiomX.db.blocklistwords", "count_triggers", (), 0)),
            create_task(safe_call("AxiomX.db.blocklistwords", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.autofilter", "get_files_count", (), 0)),
            create_task(safe_call("AxiomX.db.autofilter", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.chatbot", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.filter", "count_total_filters", (), 0)),
            create_task(safe_call("AxiomX.db.filter", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.antiflood", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.antiraid", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.approval_db", "approvals_summary", (), "0 approved, 0 chats")),
            create_task(safe_call("AxiomX.db.greetings", "count_chats", (), None)),
            create_task(safe_call("AxiomX.db.greetings", "count_welcome_chats", (), 0)),
            create_task(safe_call("AxiomX.db.greetings", "count_goodbye_chats", (), 0)),
            create_task(safe_call("AxiomX.db.notes", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.fsub", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.translate", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.locks_db", "locks_collection.distinct", ("chat_id",), [])),
            create_task(safe_call("AxiomX.db.riddle", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.ignore", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.afk", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.rules", "count_rules_chats", (), 0)),
            create_task(safe_call("AxiomX.db.reaction", "count_chats", (), 0)),
            create_task(safe_call("AxiomX.db.disable", "count_disabled_items", (), 0)),
            create_task(safe_call("AxiomX.db.disable", "count_chats", (), 0)),
