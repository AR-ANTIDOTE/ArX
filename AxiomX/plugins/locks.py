...
import re
import html
from AxiomX import DEV_LIST, pbot, font
from AxiomX.helpers.data.fonts import Fonts
from AxiomX.db.approval_db import is_user_approved
from AxiomX.helpers.decorator import Command, Messages, admin_check, only_groups, Callbacks, prefix_cmds, is_sudo_user_db
...
from AxiomX.db.locks_db import (
    get_locks, update_lock, remove_lock, is_locked,
    remove_all_locks, set_lockwarn, get_lockwarn, set_adminlock, get_adminlock
)
from AxiomX.db.warn_db import add_warn, get_warns, get_warn_limit, reset_warns, get_warn_action
...
async def locktoggle_callback(client: Client, query: PyroCallbackQuery):
    from AxiomX.helpers.decorator import get_effective_chat_id_pyro
    ...
    from AxiomX import app as ptb_app
